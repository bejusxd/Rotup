...
def build_exe():
    ...
    print("=" * 60)
    print("ROTUP v0.7.1 alpha - Building Windows Executable")
    print("=" * 60)
    ...
    try:
        ...
        # Create README
        readme_content = """ROTUP v0.7.1 - Rotation Backup Tool
=====================================
...
"""
        ...
        shutil.make_archive("dist/ROTUP_v0.7.1_Windows_Portable", "zip", "dist", "ROTUP_Portable")

        print("\n✅ ============================================")
        print("✅ Build process completed!")
        print("✅ ============================================")
        print(f"\n📦 Standalone EXE: dist/ROTUP.exe")
        print(f"📦 Portable package: dist/ROTUP_v0.7.1_Windows_Portable.zip")
